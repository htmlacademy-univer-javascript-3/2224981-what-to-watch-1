          ...
          <div className="film-card__wrap">
            <div className="film-card__desc">
              ...
              <div className="film-card__buttons">
                ...
                <Link to={AppRoutes.FilmsRoot + props.film.id + AppRoutes.FilmsReview} className="btn film-card__button">Add review</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="film-card__wrap film-card__translate-top">
          <div className="film-card__info">
            <div className="film-card__poster film-card__poster--big">
              <img src={props.film.posterImage} width="218" height="327"/>
            </div>
            ...
            <div className="film-card__desc">
              ...
              <div className="film-rating">
                ...
                <p className="film-rating__meta">
                  <span className="film-rating__level">{ratingToString(props.film.rating)}</span>
              ...
              <div className="film-card__text">
                ...
                <p className="film-card__starring">
                  <strong>
                    Starring: {props.film.starring.join(', ')}
                  </strong>
                </p>
              </div>
            </div>
      ...
      <div className="page-content">
        <section className="catalog catalog--like-this">
          ...
          <div className="catalog__films-list">
            <FilmList films={props.recommendedFilms}/>
          </div>
        </section>
